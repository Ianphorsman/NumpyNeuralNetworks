...
class LstmNode:
    ...
    def top_diff_is(self, top_diff_h, top_diff_s):
        ...
        di_input = self.d_sigmoid(self.state.i) * di
        df_input = self.d_sigmoid(self.state.f) * df
        do_input = self.d_sigmoid(self.state.o) * do
        dg_input = self.d_tanh(self.state.g) * dg
